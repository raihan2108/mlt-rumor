...
class MLT_US:
    ...
    def build_graph(self):
        ...
        with tf.variable_scope('stance-clf'):
            ...
            self.stance_score = tf.nn.relu(tf.matmul(output, weight) + bias)
    ...
    def test_model(self, sess: tf.Session, data_loader):
        ...
        for i in range(0, n_batches):
            ...
            avg_macro_f1_stance /= self.batch_size
            avg_micro_f1_stance /= self.batch_size
            avg_acc_stance /= self.batch_size
