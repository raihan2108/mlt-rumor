    ...
    def build_graph(self):
        ...
        with tf.variable_scope('rumor'):
            ...
            self.rumor_rnn_output, self.rumor_hidden_state = \
                tf.nn.dynamic_rnn(self.rnn_cell_rumor, self.rnn_inputs_nodes, self.seq_len, self.init_state_rumor)
        ...
        with tf.variable_scope('stance'):
            ...
            self.stance_rnn_output, self.stance_hidden_state = \
                tf.nn.dynamic_rnn(self.rnn_cell_stance, self.rnn_inputs_nodes, self.seq_len, self.init_state_stance)
